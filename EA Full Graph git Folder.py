...
gnodes = 3 #Divide iternum by this to get the interval over which the graphs will be saved. i.e. 200/10 = 20 iterations or 2000J/2kJ
gnodes2 = 3
chngamnt = 100.0 #float(input('Enter Activation Energy change per iteration [J/mol] --> '))
iternum = 3 #int(input('Enter total iterations --> '))
graph_num = 1
...
for i in range(len(namestxt)):
    path_folna = r"{}\Activation Energy - Full\{}".format(dir_path, namestxt[i])
    try:
        os.mkdir(path_folna)
    except Exception:
        pass
...
for i, jd in enumerate(concl):
    nameD = namestxt[i]
    nameD2 = namestxte[i]
    path_folnn = r"{}\Activation Energy - Full\{}\{}".format(dir_path, nameD, nameD)
    try:
        os.mkdir(path_folnn)
    except Exception:
        pass
    ...
    for jj, j in enumerate(graph_nodes):
        ...
        fig.savefig(r"{}\{} Concentration {}.pdf".format(path_folnn, nameD, int(Ea_vals[j])))
        fig.savefig(r"{}\{} Concentration {}.svg".format(path_folnn, nameD, int(Ea_vals[j])))
        plt.close()
    for jt, tj in enumerate(graph_nodes):
        ...
        plt.ylabel(r'Concentration [$\frac{mol}{m^3}$]')
        plt.title(r'{} Concentration'.format(nameD2), fontdict=font)
        fig.savefig(r"{}\{} Concentration Time {}.pdf".format(path_folnn, nameD, int(Ea_vals[tj])))
        fig.savefig(r"{}\{} Concentration Time {}.svg".format(path_folnn, nameD, int(Ea_vals[tj])))
        plt.close()
...
for i, j in enumerate(concl):
    ...
    nameD = namestxt[i]
    nameD2 = namestxte[i]
    path_folnnb = r"{}\Activation Energy - Full\{}\{}".format(dir_path, nameD, nameD)
    try:
    ...
    plt.ylabel(r'Concentration [$\frac{mol}{m^3}$]')
    plt.title(r'{} Concentration'.format(nameD2), fontdict=font)
    fig.savefig(r"{}\{} Concentration Time {}.pdf".format(path_folnnb, nameD, int(Ea_vals[tj])))
    fig.savefig(r"{}\{} Concentration Time {}.svg".format(path_folnnb, nameD, int(Ea_vals[tj])))
    plt.close()
...
for i, j in enumerate(concjl):
    ...
    nameDj = namestxt[i]
    nameD2j = namestxte[i]
    path_folnnj = r"{}\Activation Energy - Full\{}\{}".format(dir_path, nameDj, "{} - J".format(nameDj))
    try:
    ...
    for jj, j in enumerate(graph_nodes):
        ...
        fig.savefig(r"{}\{} Concentration J-{}.pdf".format(path_folnnj, nameDj, int(Ea_vals[j])))
        fig.savefig(r"{}\{} Concentration J-{}.svg".format(path_folnnj, nameDj, int(Ea_vals[j])))
        plt.close()
    for jtj, tjt in enumerate(graph_nodes):
        ...
        plt.ylabel(r'Concentration [$\frac{mol}{m^3}$]')
        plt.title(r'{} Concentration - Jacobian'.format(nameD2j), fontdict=font)
        fig.savefig(r"{}\{} Concentration Time J {}.pdf".format(path_folnnj, nameDj, int(Ea_vals[tj])))
        fig.savefig(r"{}\{} Concentration Time J {}.svg".format(path_folnnj, nameDj, int(Ea_vals[tj])))
        plt.close()
...
for i, j in enumerate(concjl):
    ...
    nameDj = namestxt[i]
    nameD2j = namestxte[i]
    path_folnnjb = r"{}\Activation Energy - Full\{}\{}".format(dir_path, nameDj, "{} - J".format(nameDj))
    try:
    ...
    plt.ylabel(r'Concentration [$\frac{mol}{m^3}$]')
    plt.title(r'{} Concentration - Jacobian'.format(nameD2j), fontdict=font)
    fig.savefig(r"{}\{} Concentration Time J {}.pdf".format(path_folnnjb, nameDj, int(Ea_vals[tj])))
    fig.savefig(r"{}\{} Concentration Time J {}.svg".format(path_folnnjb, nameDj, int(Ea_vals[tj])))
    plt.close()
    fig = plt.figure()
