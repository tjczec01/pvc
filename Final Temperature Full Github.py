...
from sympy import init_printing, symbols, exp, init_session, simplify, latex, Function, derive_by_array, Add, Float, Mul, Integer, Pow, Symbol
import thermo as tc
...
#ll1 = len(y0) - 2
#pyis = [i*(1.0/(ll1)) for i in range(0,ll1,1)]

#kvalmix = kmix(Temp_K,mfracs,kks,Tbl,pvis,mws)
#
#pmix = tc.Mixture(IDs = names, zs=pyis, ws=mfracs, T=float(Temp_K), P=PascalP)
#pkval2 = tc.thermal_conductivity.Lindsay_Bromley(Temp_K, mfracs, kks, Tbl, pvis, mws)
#print("Python: {}, Thermo: {}".format(kvalmix,pkval2))
rtolval = 1E-7
rtolvalj = 1E-7
atolval = 1E-7
atolvalj = 1E-7
