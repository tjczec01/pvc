...
reacteqs2 = []
prodeqs2 = []
namespdf = ['EDC', 'EC', 'HCl', 'Coke', 'CP', 'Di', 'Tri', 'C4H6Cl2', 'C6H6', 'C2H2', 'C11', 'C112', 'C1112', 'R1', 'R2', 'R3', 'R4', 'R5', 'R6', 'R7', 'R8', 'CCl4', 'CHCl3', 'VCM', 'Temperature', 'Temp Differential', 'Purity', 'Selectivity VCM', 'Selectivity HCl', 'Yield VCM']
...
Tc = 500.0
Tk = Tc + 273.15
gas_constant = 8.31446261815324 # [J / *mol]
...
for il in tqdm(range(iternum)):
    ...
    for x2 in dist_c:
        ...
        resa = solve_ivp(RHSfull, [0.0, Ls], Y0, method='Radau', args=(gas_constant, 5900000000000000.0, 2200000.0, 13000000.0, 12000000.0, 1000000.0, 500000.0, 200000.0, 100000.0, 1000000.0, 10000000.0, 10000000.0, 17000000.0, 12000000.0, 17000000.0, 17000000.0, 16000000.0, 91000.0, 120000000.0, 300000.0, 20000.0, 500000.0, 210000000000000.0, 500000000000000.0, 20000000000000.0, 25000000000000.0, 1000000.0, 500000.0, 500000.0, 10000000.0, 100000000.0, 160000000.0, 342.0 * 1000.0, 230000.0, 7000.0, 34000.0, 42000.0, 45000.0, 48000.0, 56000.0, 63000.0, 13000.0, 12000.0, 4000.0, 6000.0, 15000.0, 17000.0, 14000.0, 0.0, 56000.0, 61000.0, 30000.0, 31000.0, 84000.0, 90000.0, 70000.0, 70000.0, 33000.0, 33000.0, 33000.0, 13000.0, 20000.0, 70000.0, float(c1_vals[-1]), float(c2_vals[-1]), float(c3_vals[-1]), float(amount_new)), jac=jacobfull, first_step=1 / segment_second, max_step=1 / (0.5 * segment_second))  # first_step=1E-2, max_step=1E-3, jac= lambda Z, C: jacob(Z,C, **args), rtol=1E-9, atol=1E-9        Ls2 = firststepval
        resb = solve_ivp(RHSfull, [0.0, Ls], Y0j, method='Radau', args=(gas_constant, 5900000000000000.0, 2200000.0, 13000000.0, 12000000.0, 1000000.0, 500000.0, 200000.0, 100000.0, 1000000.0, 10000000.0, 10000000.0, 17000000.0, 12000000.0, 17000000.0, 17000000.0, 16000000.0, 91000.0, 120000000.0, 300000.0, 20000.0, 500000.0, 210000000000000.0, 500000000000000.0, 20000000000000.0, 25000000000000.0, 1000000.0, 500000.0, 500000.0, 10000000.0, 100000000.0, 160000000.0, 342.0 * 1000.0, 230000.0, 7000.0, 34000.0, 42000.0, 45000.0, 48000.0, 56000.0, 63000.0, 13000.0, 12000.0, 4000.0, 6000.0, 15000.0, 17000.0, 14000.0, 0.0, 56000.0, 61000.0, 30000.0, 31000.0, 84000.0, 90000.0, 70000.0, 70000.0, 33000.0, 33000.0, 33000.0, 13000.0, 20000.0, 70000.0, float(c1_valsj[-1]), float(c2_valsj[-1]), float(c3_valsj[-1]), float(amount_new)), jac=jacobfull, first_step=1 / segment_second, max_step=1 / (0.5 * segment_second))  # first_step=1E-2, max_step=1E-3, jac= lambda Z, C: jacob(Z,C, **args), rtol=1E-9, atol=1E-9        Ls2 = firststepval
...
namestxt = ['EDC', 'EC', 'HCl', 'Coke', 'CP', 'Di', 'Tri', 'C4H6Cl2', 'C6H6', 'C2H2', 'C11', 'C112', 'C1112', 'R1', 'R2', 'R3', 'R4', 'R5', 'R6', 'R7', 'R8', 'CCL4', 'CHCL3', 'VCM', 'Temperature', 'Temperature Differential', 'Purity', 'Reynolds Number', 'Overall Heat Transfer Coefficient', 'Heat Transfer Coefficient', 'Mixture Thermal Conductivity', 'Constant 1', 'Constant 2', 'Constant 3', "Conversion", 'Selectivity VCM', 'Selectivity HCl', 'Yield VCM']
namestxte = ['EDC', 'EC', 'HCl', 'Coke', 'CP', 'Di', 'Tri', 'C4H6Cl2', 'C6H6', 'C2H2', 'C11', 'C112', 'C1112', 'R1', 'R2', 'R3', 'R4', 'R5', 'R6', 'R7', 'R8', 'CCL4', 'CHCL3', 'VCM', 'Temperature', 'dT', 'Purity', 'Reynolds Number', 'U Coefficient', 'H Coefficient', 'K Coefficient', 'Constant 1', 'Constant 2', 'Constant 3', "Conversion", 'Selectivity VCM', 'Selectivity HCl', 'Yield VCM']
...
tvals, tvalsr = np.array(Temp_vals, ndmin=1), np.array(Temp_valsrev, ndmin=1)


for i in range(len(namestxt)):
    path_folna = r"{}\Temperature - Full\{}".format(dir_path, namestxt[i])
    try:
        os.mkdir(path_folna)
    except Exception:
        pass
...
np.savetxt(r"{}\{}\Temperature Values.txt".format(path_fol, 'Temperature'), tvals)
np.savetxt(r"{}\{}\Temperature Values Reverse.txt".format(path_fol, 'Temperature'), tvalsr)


for i, j in enumerate(textlist1):
    # print(i, textlist1.index(j))
    if i == 27 or i == 28:
        pass
    else:
        namel = namestxt[i]
...
for i, jd in enumerate(concl):
    nameD = namestxt[i]
    nameD2 = namestxte[i]
    path_folnn = r"{}\Temperature - Full\{}\{}".format(dir_path, nameD, nameD)
    try:
        os.mkdir(path_folnn)
    except Exception:
        pass
    ...
    for jj, j in enumerate(graph_nodes):
        ...
        plt.plot(dist, cur_list2, color=viridis.colors[index_jj, :], label=r"Temperature: {}$^\circ$C".format(Cval))
        plt.legend(loc='best')
        if nameD in splist:
            ...
            plt.gca().yaxis.set_major_formatter(PercentFormatter(1, decimals=None, symbol="%", is_latex=True))
        ...
        fig.savefig(r"{}\{} Concentration {} K.pdf".format(path_folnn, nameD, tvalg))
        fig.savefig(r"{}\{} Concentration {} K.svg".format(path_folnn, nameD, tvalg))
        plt.close()
    for jt, tj in enumerate(graph_nodes):
        ...
        plt.plot(timel, cur_list2, color=viridis.colors[index_jj, :], label=r"Temperature: {}$^\circ$C".format(Cval))
        plt.legend(loc='best')
        if nameD in splist:
            plt.axhline(y=float(100.0), color='k', linestyle='--')
            plt.gca().yaxis.set_major_formatter(PercentFormatter(100, decimals=None, symbol="%", is_latex=True))
        ...
        plt.ylabel(r'Concentration [$\frac{mol}{m^3}$]')
        plt.title(r'{} Concentration'.format(nameD2), fontdict=font)
        fig.savefig(r"{}\{} Concentration Time {} K.pdf".format(path_folnn, nameD, tvalg))
        fig.savefig(r"{}\{} Concentration Time {} K.svg".format(path_folnn, nameD, tvalg))
        plt.close()
...
for i, j in enumerate(concl):
    ...
    nameD = namestxt[i]
    nameD2 = namestxte[i]
    path_folnnb = r"{}\Temperature - Full\{}\{}".format(dir_path, nameD, nameD)
    try:
    ...
    plt.ylabel(r'Concentration [$\frac{mol}{m^3}$]')
    plt.title(r'{} Concentration'.format(nameD2), fontdict=font)
    fig.savefig(r"{}\{} Concentration.pdf".format(path_folnnb, nameD))
    fig.savefig(r"{}\{} Concentration.svg".format(path_folnnb, nameD))
    plt.close()
    fig2 = plt.figure()
    for jt, tj in enumerate(graph_nodes):
        cur_list2 = concl[i][jt]
    ...
    plt.ylabel(r'Concentration [$\frac{mol}{m^3}$]')
    plt.title(r'{} Concentration'.format(nameD2), fontdict=font)
    fig.savefig(r"{}\{} Concentration Time {} K.pdf".format(path_folnnb, nameD, tvalg))
    fig.savefig(r"{}\{} Concentration Time {} K.svg".format(path_folnnb, nameD, tvalg))
    plt.close()
...
for i, j in enumerate(concjl):
    ...
    nameDj = namestxt[i]
    nameD2j = namestxte[i]
    path_folnnj = r"{}\Temperature - Full\{}\{}".format(dir_path, nameDj, "{} - J".format(nameDj))
    try:
    ...
    for jj, j in enumerate(graph_nodes):
        ...
        fig.savefig(r"{}\{} Concentration J-{} K.pdf".format(path_folnnj, nameDj, tvalg))
        fig.savefig(r"{}\{} Concentration J-{} K.svg".format(path_folnnj, nameDj, tvalg))
        plt.close()
    for jtj, tjt in enumerate(graph_nodes):
        ...
        plt.ylabel(r'Concentration [$\frac{mol}{m^3}$]')
        plt.title(r'{} Concentration - Jacobian'.format(nameD2j), fontdict=font)
        fig.savefig(r"{}\{} Concentration Time J {} K.pdf".format(path_folnnj, nameDj, tvalg))
        fig.savefig(r"{}\{} Concentration Time J {} K.svg".format(path_folnnj, nameDj, tvalg))
        plt.close()
...
for i, j in enumerate(concjl):
    ...
    nameDj = namestxt[i]
    nameD2j = namestxte[i]
    path_folnnjb = r"{}\Temperature - Full\{}\{}".format(dir_path, nameDj, "{} - J".format(nameDj))
    try:
    ...
    plt.ylabel(r'Concentration [$\frac{mol}{m^3}$]')
    plt.title(r'{} Concentration - Jacobian'.format(nameD2j), fontdict=font)
    fig.savefig(r"{}\{} J.pdf".format(path_folnnjb, nameDj))
    fig.savefig(r"{}\{} J.svg".format(path_folnnjb, nameDj))
    plt.close()
    fig2 = plt.figure()
    for jtj, tjt in enumerate(graph_nodes):
        cur_list2 = concjl[i][tjt]
    ...
    plt.ylabel(r'Concentration [$\frac{mol}{m^3}$]')
    plt.title(r'{} Concentration - Jacobian'.format(nameD2j), fontdict=font)
    fig.savefig(r"{}\{} Concentration Time J {} K.pdf".format(path_folnnjb, nameDj, tvalg))
    fig.savefig(r"{}\{} Concentration Time J {} K.svg".format(path_folnnjb, nameDj, tvalg))
    plt.close()
...
plt.grid()
fig.savefig(r"{}\EDCconcentrationInitial.png".format(path_fol))  # Saves the graph
fig.savefig(r"{}\EDCconcentrationInitial.pdf".format(path_fol))  # Saves the graph
fig.savefig(r"{}\EDCconcentrationInitial.svg".format(path_fol))
plt.close()

fig, ax = plt.subplots()
ax.plot(tvals, tconvf, 'b-', label='Conversion')
ax.plot(tvals, tconvjf, 'r-', label='Conversion With Jacobian')
ax.set(xlabel="Initial Temperature [K]", ylabel='Conversion [%]', title="Final Conversion")
ax.legend()
ax.invert_xaxis()
fig.savefig(r"{}\Final Conversionback.png".format(path_fol), bbox_inches='tight')
...
fig = plt.figure()
plt1e = plt.plot(tvals, tconvf, 'b-')
plt2e = plt.plot(tvals, tconvjf, 'g-')
...
fig.savefig(r"{}\Final Conversion.pdf".format(path_fol))  # Saves the graph
fig.savefig(r"{}\Final Conversion.svg".format(path_fol))
plt.close()

path_folrs = r"{}\Temperature - Full\{}".format(dir_path, "Radicals")
try:
    os.mkdir(path_folrs)
except Exception:
    pass
...
for jj, j in enumerate(graph_nodes):
    ...
    plt.grid()
    fig.savefig(r"{}\Radical{} K.pdf".format(path_folrs, Temp_vals[j]), bbox_inches='tight')
    fig.savefig(r"{}\Radical{} K.svg".format(path_folrs, Temp_vals[j]), bbox_inches='tight')
    plt.close()
...
for jj, j in enumerate(graph_nodes):
    ...
    plt.ylabel(r'Concentration [$\frac{mol}{m^3}$]')
    plt.legend(loc='best')
    plt.title(r"Radicals Concentration at {} K - Jacobian".format(Temp_vals[j]))
    plt.grid()
    fig.savefig(r"{}\Radical J{} K.pdf".format(path_folrs, Temp_vals[j]), bbox_inches='tight')
    fig.savefig(r"{}\Radical J{} K.svg".format(path_folrs, Temp_vals[j]), bbox_inches='tight')
    plt.close()


path_folbs = r"{}\Temperature - Full\{}".format(dir_path, "By-Product")
try:
    os.mkdir(path_folbs)
except Exception:
    pass
...
for jj, j in enumerate(graph_nodes):
    ...
    plt.plot(xD, di[j, :], 'y-', label='Dichloroethylene')
    ...
    plt.grid()
    fig.savefig(r"{}\By Products{} K.pdf".format(path_folbs, Temp_vals[j]), bbox_inches='tight')
    fig.savefig(r"{}\By Products{} K.svg".format(path_folbs, Temp_vals[j]), bbox_inches='tight')
    plt.close()
...
for jj, j in enumerate(graph_nodes):
    ...
    plt.plot(xD, dij[j, :], 'y-', label='Dichloroethylene')
    ...
    plt.title(r"By-Product Concentration at {} K".format(Temp_vals[j]))
    plt.grid()
    fig.savefig(r"{}\By Products J{} K.pdf".format(path_folbs, Temp_vals[j]), bbox_inches='tight')
    fig.savefig(r"{}\By Products J{} K.svg".format(path_folbs, Temp_vals[j]), bbox_inches='tight')
    plt.close()


path_folps = r"{}\Temperature - Full\{}".format(dir_path, "Products")
try:
    os.mkdir(path_folps)
except Exception:
    pass
...
for jj, j in enumerate(graph_nodes):
    ...
    plt.grid()
    fig.savefig(r"{}\Products {} K.pdf".format(path_folps, Temp_vals[j]), bbox_inches='tight')
    fig.savefig(r"{}\Products {} K.svg".format(path_folps, Temp_vals[j]), bbox_inches='tight')
    plt.close()
...
for jj, j in enumerate(graph_nodes):
    ...
    plt.title(label=r"Temperature: {}$^\circ$C".format(Cval))
    plt.grid()
    fig.savefig(r"{}\Products J {} K.pdf".format(path_folps, Temp_vals[j]), bbox_inches='tight')
    fig.savefig(r"{}\Products J {} K.svg".format(path_folps, Temp_vals[j]), bbox_inches='tight')
    plt.close()
