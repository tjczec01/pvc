...
np.savetxt(r"{}\Tempvals.txt".format(path_fol), eavals)
eavals2 = np.array(Temp_vals2, ndmin=1)
np.savetxt(r"{}\Tempvals2.txt".format(path_fol), eavals2)
eavalsr = np.array(Temp_valsrev, ndmin=1)
np.savetxt(r"{}\Tempvals.txt".format(path_fol), eavalsr)
eavals2r = np.array(Temp_valsrev2, ndmin=1)
np.savetxt(r"{}\Tempvals2.txt".format(path_fol), eavals2r)
